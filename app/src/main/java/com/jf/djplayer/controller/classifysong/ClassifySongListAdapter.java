 ...
 * 本地音乐-歌曲列表适配器
 */
public class ClassifySongListAdapter extends BaseAdapter implements View.OnClickListener{

    private Fragment fragment;    // 适配器内需要弹出DialogFragment，传入的Fragment作为targetFragment
    private List<Song> songList;  // 歌曲列表

    public ClassifySongListAdapter(Fragment fragment, List<Song> songList){
