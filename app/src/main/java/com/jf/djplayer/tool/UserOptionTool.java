 ...
 * 用来读写用户选项的工具类
 */
public class UserOptionTool {

    private Context context;
    private static final String USER_OPTION_FILE_NAME = "userOption";//这是保存用户配置用的文件名字
...
//    播放模式相关变量设置
    ...
    public UserOptionTool(Context context){
    ...
    public void setPlayModes(int playMode){
        SharedPreferences playModePreferences = context.getSharedPreferences(USER_OPTION_FILE_NAME,Context.MODE_PRIVATE);
